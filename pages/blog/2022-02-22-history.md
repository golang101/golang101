...
# Go 101 Update History (Before v1.18)

### v1.17.b (2021/Sep/10)

* improve implicit method value evaluation explanations
...
* add [a new syntax execution](https://go101.org/article/exceptions.html#code-block-following-else).
